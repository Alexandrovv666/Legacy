<?php
    ...
    if ($_GET['page']=='o_O'){
        ...
        $html -> add_html_line(' - Исправлена ошибка входа в игру из-за механизма сессий.');
        $html -> add_html_line(' - Сам он на данный момент замечательно отлажен.');
        $html -> add_html_line(' - Добавлена справка. Та которую Вы читаете сейчас :)');
        $html -> add_html_line(' - Исправлена ошибка с текстом/цифрами в CONSTANT.');
    }
