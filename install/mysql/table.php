<?php
    ...
    mysql_query("CREATE TABLE IF NOT EXISTS `aut_history` (`time` bigint(20) NOT NULL, `login` varchar(20) NOT NULL, `ip` varchar(15) NOT NULL, `session` varchar(30) NOT NULL, `user_agent` varchar(200) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
    ...
    mysql_query("CREATE TABLE IF NOT EXISTS `session` (`time` int(11) NOT NULL, `login` varchar(20) NOT NULL, `status` varchar(7) NOT NULL, `ip` varchar(15) NOT NULL, `session` varchar(30) NOT NULL, `user_agent` varchar(200) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
    ...
    mysql_query('CREATE TABLE IF NOT EXISTS `progress` (`id_login` int(11) NOT NULL, `input` int(11) NOT NULL, `exit` int(11) NOT NULL, `golden_room_worked` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;');
    ...
    mysql_query('CREATE TABLE IF NOT EXISTS `quest_const` (`id_quest` int(11) NOT NULL, `name_quest` text NOT NULL, `descriptin_quest` text NOT NULL, `if_eq_progress_input` int(11) NOT NULL, `if_b_golden_room_worked` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;');
