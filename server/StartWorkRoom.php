...
if ($_GET['action'] == 'StartWorkRoom') {
  ...
  echo '<br><input type=range min=0 max=' . $a_room_for_work['men'] . ' value=' . $VarMen . ' id="men_for_work" oninput="CorrectMenForWork(' . $a_room_for_work['men'] . ',' . floor($a_castle['men']) . ')"><br>';
  echo '<p id="men_to_work_user">' . $VarMen . ' / ' . $a_room_for_work['men'] . '</p><br>';
