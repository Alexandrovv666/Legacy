...
`id` int(11) NOT NULL,  `x` int(11) NOT NULL,  `y` int(11) NOT NULL,  `z` int(11) NOT NULL,  `name` text NOT NULL,  `timegate` int(11) NOT NULL,
  ...
  `agold` float NOT NULL,  `atree` float NOT NULL,  `astone` float NOT NULL,  `maxres` int(11) NOT NULL, ";
    ...
    if (!(mysql_table_seek("users", "game"))) {
        mysql_query("CREATE TABLE IF NOT EXISTS `users` (`id` int(11) NOT NULL, `login` text NOT NULL,  `password` text NOT NULL,  `reg_time` int(11) NOT NULL,  `almaz` float NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
    ...
    if (!(mysql_table_seek("missions", "game"))) {
        mysql_query("CREATE TABLE IF NOT EXISTS `missions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ist_x` int(11) NOT NULL,
  `ist_y` int(11) NOT NULL,
  `ist_z` int(11) NOT NULL,
  `vladelez` int(11) NOT NULL,
  `k_x` int(11) NOT NULL,
  `k_y` int(11) NOT NULL,
  `k_z` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    if (!(mysql_table_seek("lager", "game"))) {
        mysql_query("CREATE TABLE IF NOT EXISTS `lager` (`x` int(11) NOT NULL, `y` int(11) NOT NULL, `z` int(11) NOT NULL, `level` int(11) NOT NULL, `gold` int(11) NOT NULL, `tree` int(11) NOT NULL, `stone` int(11) NOT NULL, `army1` int(11) NOT NULL, `army2` int(11) NOT NULL, `army3` int(11) NOT NULL, `army4` int(11) NOT NULL, `army5` int(11) NOT NULL, `army6` int(11) NOT NULL, `army7` int(11) NOT NULL, `army8` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
        echo '=> CREATE TABLE `lager`<br>';
    }
    if (!(mysql_table_seek("mail", "game"))) {
        mysql_query("CREATE TABLE IF NOT EXISTS `mail` (`id` int(11) NOT NULL, `adresat` text NOT NULL,  `autor` text NOT NULL,  `time` int(11) NOT NULL,  `type`  int(11) NOT NULL, `theme` text NOT NULL, `text` text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
        mysql_query("ALTER TABLE `users` MODIFY COLUMN `id` INT AUTO_INCREMENT;");
        echo '=> CREATE TABLE `users`<br>';
    }
