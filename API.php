...
function FConnBase(){
    $link = mysql_connect("legacyofwarriors", "root", "") or die('Пожалуйста, перезагрузите страницу.<br>Если подобное повторяется, свяжитесь с Администрацией и сообщите ей сообщение ошибки.<br>Сообщение <u>'.mysql_error().'</u>');
