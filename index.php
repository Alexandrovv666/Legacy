...
//PEAR style
    ...
    F_echo_html_head();
    echo '<script src="src/index.js"></script><script src="game/js/v_1/jquery.min.js"></script><link rel="stylesheet" href="default.css"><div id="fon"><div id="fon-alert"></div></div><img id="logo" src="game/img/Menu/logo.png"><div id="window"><div id="link-license"><a href="Liz.php">'.$C_lang_licenze.'</a></div>';
    if ( $_GET[ 'game' ] == 'reg' )
