<div id="window_modal_1" class="modalDialog">
  <div>
    <a href="#close" title="Закрыть" class="close" onclick="reset_window_modal_1()">
      X
    </a>
    <div id="get_data_window_modal_1">
      <img src="Img/interface/other/loading.gif" width="34px">
    </div>
  </div>
</div>
<?    if ($_COOKIE['ort'] == 'map')
